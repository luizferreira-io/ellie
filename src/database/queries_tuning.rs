    ...
    || {
        ...
        map.insert(
            ...
            DatabaseTable {
                #[rustfmt::skip]
                columns: vec![
                    DatabaseColumnDefinition { field: "tablespace_name", title: "Tablespace", width: 25 },
                    DatabaseColumnDefinition { field: "owner",           title: "Owner",      width: 20 },
                    DatabaseColumnDefinition { field: "size",            title: "Size",       width: 15 },
                    DatabaseColumnDefinition { field: "path",            title: "Path",       width: 50 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                #[rustfmt::skip]
                columns: vec![
                    DatabaseColumnDefinition { field: "db_name",         title: "Database",   width: 25 },
                    DatabaseColumnDefinition { field: "owner",           title: "Owner",      width: 20 },
                    DatabaseColumnDefinition { field: "size",            title: "Size",       width: 15 },
                    DatabaseColumnDefinition { field: "tablespace_name", title: "Tablespace", width: 25 },
                    DatabaseColumnDefinition { field: "collate",         title: "Collate",    width: 20 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    DatabaseColumnDefinition { field: "schema_name",     title: "Schema",     width: 25 },
                    DatabaseColumnDefinition { field: "owner",           title: "Owner",      width: 20 },
                    DatabaseColumnDefinition { field: "total_size",      title: "Size",       width: 15 },
                    DatabaseColumnDefinition { field: "percentage",      title: "% of DB",    width: 10 },
                    DatabaseColumnDefinition { field: "tablespace_name", title: "Tablespace", width: 25 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    DatabaseColumnDefinition { field: "schema_name",       title: "Schema",           width: 15 },
                    DatabaseColumnDefinition { field: "table_name",        title: "Table",            width: 30 },
                    DatabaseColumnDefinition { field: "owner",             title: "Owner",            width: 20 },
                    DatabaseColumnDefinition { field: "disk_size",         title: "Size",             width: 12 },
                    DatabaseColumnDefinition { field: "disk_total_size",   title: "Total Size",       width: 12 },
                    DatabaseColumnDefinition { field: "live_tuples",       title: "Live Tuples",      width: 14 },
                    DatabaseColumnDefinition { field: "dead_tuples",       title: "Dead Tuples",      width: 14 },
                    DatabaseColumnDefinition { field: "bloat_percentage",  title: "Bloat %",          width: 10 },
                    DatabaseColumnDefinition { field: "vacuum_count",      title: "Vacuums",          width: 10 },
                    DatabaseColumnDefinition { field: "last_vacuum",       title: "Last Vacuum",      width: 22 },
                    DatabaseColumnDefinition { field: "autovacuum_count",  title: "Auto Vacuums",     width: 14 },
                    DatabaseColumnDefinition { field: "last_autovacuum",   title: "Last Autovacuum",  width: 22 },
                    DatabaseColumnDefinition { field: "analyze_count",     title: "Analyzes",         width: 12 },
                    DatabaseColumnDefinition { field: "last_analyze",      title: "Last Analyze",     width: 22 },
                    DatabaseColumnDefinition { field: "autoanalyze_count", title: "Auto Analyzes",    width: 15 },
                    DatabaseColumnDefinition { field: "last_autoanalyze",  title: "Last Autoanalyze", width: 22 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",        title: "Table",            width: 30 },
                    DatabaseColumnDefinition { field: "owner",             title: "Owner",            width: 20 },
                    DatabaseColumnDefinition { field: "bloat_size",        title: "Bloat Size",       width: 15 },
                    DatabaseColumnDefinition { field: "bloat_percentage",  title: "Bloat %",          width: 10 },
                    DatabaseColumnDefinition { field: "disk_size",         title: "Size",             width: 12 },
                    DatabaseColumnDefinition { field: "disk_total_size",   title: "Total Size",       width: 12 },
                    DatabaseColumnDefinition { field: "live_tuples",       title: "Live Tuples",      width: 14 },
                    DatabaseColumnDefinition { field: "dead_tuples",       title: "Dead Tuples",      width: 14 },
                    DatabaseColumnDefinition { field: "fill_factor",       title: "Fill Factor %",    width: 13 },
                    DatabaseColumnDefinition { field: "vacuum_count",      title: "Vacuums",          width: 10 },
                    DatabaseColumnDefinition { field: "last_vacuum",       title: "Last Vacuum",      width: 22 },
                    DatabaseColumnDefinition { field: "autovacuum_count",  title: "Auto Vacuums",     width: 14 },
                    DatabaseColumnDefinition { field: "last_autovacuum",   title: "Last Autovacuum",  width: 22 },
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",         title: "Table",             width: 30 },
                    DatabaseColumnDefinition { field: "owner",              title: "Owner",             width: 20 },
                    DatabaseColumnDefinition { field: "total_activity",     title: "Total Activity",    width: 15 },
                    DatabaseColumnDefinition { field: "inserts",            title: "Inserts",           width: 12 },
                    DatabaseColumnDefinition { field: "updates",            title: "Updates",           width: 12 },
                    DatabaseColumnDefinition { field: "deletes",            title: "Deletes",           width: 12 },
                    DatabaseColumnDefinition { field: "inserts_percentage", title: "Ins %",             width: 10 },
                    DatabaseColumnDefinition { field: "updates_percentage", title: "Upd %",             width: 10 },
                    DatabaseColumnDefinition { field: "deletes_percentage", title: "Del %",             width: 10 },
                    DatabaseColumnDefinition { field: "newpage_updates",    title: "New page Updates",  width: 18 },
                    DatabaseColumnDefinition { field: "hot_updates",        title: "HOT Updates",       width: 14 },
                    DatabaseColumnDefinition { field: "live_tuples",        title: "Live Tuples",       width: 14 },
                    DatabaseColumnDefinition { field: "dead_tuples",        title: "Dead Tuples",       width: 14 },
                    DatabaseColumnDefinition { field: "bloat_percentage",   title: "Bloat %",           width: 10 },
                    DatabaseColumnDefinition { field: "vacuum_count",       title: "Vacuums",           width: 10 },
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",             title: "Table",             width: 30 },
                    DatabaseColumnDefinition { field: "owner",                  title: "Owner",             width: 20 },
                    DatabaseColumnDefinition { field: "newpage_updates",        title: "New page Upd",      width: 14 },
                    DatabaseColumnDefinition { field: "newpage_upd_percentage", title: "New page Upd %",    width: 14 },
                    DatabaseColumnDefinition { field: "total_activity",         title: "Total Activity",    width: 15 },
                    DatabaseColumnDefinition { field: "inserts",                title: "Inserts",           width: 12 },
                    DatabaseColumnDefinition { field: "updates",                title: "Updates",           width: 12 },
                    DatabaseColumnDefinition { field: "deletes",                title: "Deletes",           width: 12 },
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",         title: "Table",            width: 30 },
                    DatabaseColumnDefinition { field: "owner",              title: "Owner",            width: 20 },
                    DatabaseColumnDefinition { field: "hot_updates",        title: "HOT Upd",          width: 10 },
                    DatabaseColumnDefinition { field: "hot_upd_percentage", title: "HOT Upd %",        width: 10 },
                    DatabaseColumnDefinition { field: "total_activity",     title: "Total Activity",   width: 15 },
                    DatabaseColumnDefinition { field: "inserts",            title: "Inserts",          width: 12 },
                    DatabaseColumnDefinition { field: "updates",            title: "Updates",          width: 12 },
                    DatabaseColumnDefinition { field: "deletes",            title: "Deletes",          width: 12 },
                    ...
                    DatabaseColumnDefinition { field: "updates_percentage", title: "Upd %",            width: 10 },
                    DatabaseColumnDefinition { field: "deletes_percentage", title: "Del %",            width: 10 },
                    DatabaseColumnDefinition { field: "newpage_updates",    title: "Newpage Updates",  width: 18 },
                    DatabaseColumnDefinition { field: "live_tuples",        title: "Live Tuples",      width: 14 },
                    DatabaseColumnDefinition { field: "dead_tuples",        title: "Dead Tuples",      width: 14 },
                    DatabaseColumnDefinition { field: "bloat_percentage",   title: "Bloat %",          width: 10 },
                    DatabaseColumnDefinition { field: "vacuum_count",       title: "Vacuums",          width: 10 },
        ...
        map.insert(
            ...
            DatabaseTable {
                ...
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",     title: "Table",            width: 30 },
                    DatabaseColumnDefinition { field: "owner",          title: "Owner",            width: 20 },
                    DatabaseColumnDefinition { field: "seq_scans",      title: "Seq Scans",        width: 12 },
                    DatabaseColumnDefinition { field: "tuple_reads",    title: "Tuple Reads",      width: 14 },
                    DatabaseColumnDefinition { field: "tuples_average", title: "Avg Tup/Seq Scan", width: 16 },
                    DatabaseColumnDefinition { field: "index_scans",    title: "Index Scans",      width: 12 },
                ],
                query: r###"
                    SELECT pg_stat_user_tables.schemaname AS schema_name,
                        pg_stat_user_tables.relname AS table_name,
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",   title: "Table",       width: 30 },
                    DatabaseColumnDefinition { field: "owner",        title: "Owner",       width: 20 },
                    DatabaseColumnDefinition { field: "index_name",   title: "Index",       width: 40 },
                    DatabaseColumnDefinition { field: "used_times",   title: "Used Times",  width: 15 },
                    DatabaseColumnDefinition { field: "index_size",   title: "Index Size",  width: 15 },
                    DatabaseColumnDefinition { field: "tuples_read",  title: "Tuples Read", width: 15 },
                    DatabaseColumnDefinition { field: "tuples_fetch", title: "Tuples Fetch", width: 15 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "table_name",           title: "Table",           width:  30 },
                    DatabaseColumnDefinition { field: "owner",                title: "Owner",           width:  20 },
                    DatabaseColumnDefinition { field: "redundant_index_name", title: "Redundant Index", width:  30 },
                    DatabaseColumnDefinition { field: "covering_index_name",  title: "Covering Index",  width:  30 },
                    DatabaseColumnDefinition { field: "redundant_index_ddl",  title: "Redundant DDL",   width: 120 },
                    DatabaseColumnDefinition { field: "covering_index_ddl",   title: "Covering DDL",    width: 120 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "schema_name",   title: "Schema",     width: 15 },
                    DatabaseColumnDefinition { field: "object_name",   title: "Object",     width: 30 },
                    DatabaseColumnDefinition { field: "owner",         title: "Owner",      width: 20 },
                    DatabaseColumnDefinition { field: "object_type",   title: "Type",       width: 20 },
                    DatabaseColumnDefinition { field: "cache_size",    title: "Cache Size", width: 12 },
                    DatabaseColumnDefinition { field: "cache_percent", title: "Cache %",    width: 10 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    DatabaseColumnDefinition { field: "database_name",   title: "Database",    width: 25 },
                    DatabaseColumnDefinition { field: "owner",           title: "Owner",       width: 20 },
                    DatabaseColumnDefinition { field: "disk_reads",      title: "Disk Reads",  width: 14 },
                    DatabaseColumnDefinition { field: "cache_reads",     title: "Cache Reads", width: 14 },
                    DatabaseColumnDefinition { field: "cache_hit_ratio", title: "Cache Hit %", width: 12 },
                ],
                query: r###"
                    SELECT pg_database.datname AS database_name,
        ...
        map.insert(
            ...
            DatabaseTable {
                columns: vec![
                    ...
                    DatabaseColumnDefinition { field: "schema_name",           title: "Schema",               width: 15 },
                    DatabaseColumnDefinition { field: "table_name",            title: "Table",                width: 30 },
                    DatabaseColumnDefinition { field: "table_owner",           title: "Owner",                width: 20 },
                    DatabaseColumnDefinition { field: "total_cache_hit_ratio", title: "Cache Hit %",          width: 12 },
                    DatabaseColumnDefinition { field: "disk_reads_heap",       title: "Disk Reads (Heap)",    width: 16 },
                    DatabaseColumnDefinition { field: "cache_reads_heap",      title: "Cache Reads (Heap)",   width: 18 },
                    DatabaseColumnDefinition { field: "disk_reads_index",      title: "Disk Reads (Index)",   width: 17 },
                    DatabaseColumnDefinition { field: "cache_reads_index",     title: "Cache Reads (Index)",  width: 19 },
                ],
                query: r###"
        ...
        map.insert(
            ...
            DatabaseTable {
                #[rustfmt::skip]
                columns: vec![
                    DatabaseColumnDefinition { field: "database",            title: "Database",            width: 20 },
                    DatabaseColumnDefinition { field: "username",            title: "User",                width: 15 },
                    DatabaseColumnDefinition { field: "query",               title: "Query",               width: 60 },
                    DatabaseColumnDefinition { field: "total_exec_sec",      title: "Total Exec (s)",      width: 16 },
                    DatabaseColumnDefinition { field: "calls",               title: "Calls",               width: 10 },
                    DatabaseColumnDefinition { field: "min_exec_sec",        title: "Min Exec (s)",        width: 12 },
                    DatabaseColumnDefinition { field: "max_exec_sec",        title: "Max Exec (s)",        width: 12 },
                    DatabaseColumnDefinition { field: "mean_exec_sec",       title: "Mean Exec (s)",       width: 13 },
                    DatabaseColumnDefinition { field: "rows",                title: "Rows",                width: 10 },
                    DatabaseColumnDefinition { field: "shared_blks_read",    title: "Shared Blks Read",    width: 18 },
                    DatabaseColumnDefinition { field: "shared_blks_written", title: "Shared Blks Written", width: 20 },
                ],
                query: r###"
